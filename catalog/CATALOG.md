...
| update-project-foundation | tool | automation | safe-write | `tools/automation/update_project_foundation.ps1` | Sincroniza toolkit, actualiza `toolkit.lock.json` con commits reales y ejecuta la guarda local. |
